...
variable, the label "to", and a value input.](/blockly/images/variables-set.png)
...
[value input](/blockly/guides/create-custom-blocks/define/block-anatomy#value_inputs)
...
fields.](/blockly/images/structure-json/set-one-to-two.png)
...
inputs.](/blockly/images/structure-json/one-plus-two.png)
...
*   An [end-of-row input](/blockly/guides/create-custom-blocks/define/block-anatomy#end-of-row_inputs)
...
input.](/blockly/images/structure-json/one-plus-two-three.png)
...
input.](/blockly/images/structure-json/is-empty-dummy.png)
...
![Map the message "%1 is empty" to a value input and an automatically created dummy
input.](/blockly/images/structure-json/is-empty.png)
...
order](#interpolation_token_order).
...
right-aligned.](/blockly/images/send-email.png)
...
(`'\n'`)](#text_handling). There is also the deprecated property
...
input.](/blockly/images/repeat.png)
...
input.](/blockly/images/structure-json/controls-repeat-ext.png)
...
input.](/blockly/images/variables-set.png)
...
"to", and a dropdown field for the variable.](/blockly/images/variables-put.png)

Blockly automatically changed the order of the fields, [created a dummy
input](#dummy_input_at_end_of_message), and switched from external to internal
inputs.
...
interpolation](/blockly/guides/configure/web/translations#json_message_interpolation).
...
input.](/blockly/images/structure-json/newline-character.png)
 ...
 * [**Fields**](/blockly/guides/create-custom-blocks/fields/overview):
   ...
   * [`field_colour`](/blockly/guides/create-custom-blocks/fields/built-in-fields/colour)
   * [`field_number`](/blockly/guides/create-custom-blocks/fields/built-in-fields/number)
   * [`field_angle`](/blockly/guides/create-custom-blocks/fields/built-in-fields/angle)
