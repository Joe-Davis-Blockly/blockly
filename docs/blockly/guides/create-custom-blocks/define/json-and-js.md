...
![A `string_length` block.](/blockly/images/text-length.png)
...
<Tabs groupId="tab">
  <TabItem value="json" label="JSON" default>
    ...
    ```
    `defineBlocksWithJsonArray` converts each JSON object into a [block definition object](/blockly/guides/create-custom-blocks/define/block-definitions)
