...
![connections with different dimensions][overridden-connection-constants-image]{: width="300"}
...
![connections with different shapes][overridden-connection-shapes-image]{: width="100"}
...
![different connections with different shapes][connection-check-specific-shapes-image]{: width="300"}
...
Custom inputs can either:
  ...
  * Affect the outline of your block, like statement inputs
    ...
    ![image of outline inputs][outline-inputs-image]{: width="150" }

  * Or affect the internals of your block, like inline value inputs

    ![image of internal inputs][internal-inputs-image]{: width="200" }
...
[connection-check]: /blockly/guides/create-custom-blocks/type-checks
...
[measurable]: /blockly/guides/create-custom-blocks/renderers/concepts/overview#block_measurables
