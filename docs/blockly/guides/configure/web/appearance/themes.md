...
-   `hat` (optional) - Adds a hat to a block, if the value is set to `cap`.
    Learn more about
    [hats](/blockly/guides/design/applications#event_driven_program).

![Block with arrows pointing to primary, secondary and tertiary
colour](/blockly/images/ColourExplanation.png){: width="450"}
...
![Screenshot of toolbox with different category colours](/blockly/images/CategoryColours.png)
...
[block style](/blockly/guides/configure/web/themes#block_style) property.
