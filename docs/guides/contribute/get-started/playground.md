...
[npm installed on your machine](/blockly/guides/modify/development_setup#npm)
...
from the root of Blockly. Make sure there is nothing else listening on port
8080. This command will start a server hosting the Blockly modules and
...
[Building Blockly page](/blockly/guides/modify/web/building) for more
