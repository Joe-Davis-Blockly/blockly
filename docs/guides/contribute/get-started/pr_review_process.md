---
description: The process a pull request goes through before being merged.
---
...
pull requests through review and merged.
...
Or they could be larger things like asking you to reorganize your function
definitions.

Reviewers are encouraged to use [GitHub's code
reviews](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/reviewing-proposed-changes-in-a-pull-request#starting-a-review) (rather
...
Often a second review is simple and focuses on nits such as punctuation and code
...
achievement that many people never start, let alone complete!
