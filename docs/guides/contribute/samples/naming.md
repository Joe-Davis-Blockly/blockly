...
Consistent plugin names are helpful for organizing and searching plugins, and
for finding published plugins on npm.

This page lists our standard plugin naming conventions. If your plugin doesn't
fit in any of the categories, use the generic plugin naming format at the end of
the page.

We recommend you add the suggested tags in your `package.json` to make it easier
...
[theme](/blockly/guides/configure/web/themes).
...
[`@blockly/theme-modern`]: https://www.npmjs.com/package/@blockly/theme-modern
