...
[shadow-block]: /blockly/guides/configure/web/toolboxes/preset#shadow_blocks
...
[toolbox]: /blockly/guides/configure/web/toolbox
...
![Block built from a value input, an end-of-row input, and a statement input.][inputs-img]
