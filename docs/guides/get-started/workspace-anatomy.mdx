...
|------------------|------------------------------------------------------|
| Output           | <Image alt="an output connection" src="/blockly/images/connections/output-connection.png" width="40px" />   |
| Input            | <Image alt="an input connection" src="/blockly/images/connections/input-connection.png" width="45px" />    |
| Previous         | <Image alt="a previous connection" src="/blockly/images/connections/previous-connection.png" width="50px" /> |
| Next             | <Image alt="a next connection" src="/blockly/images/connections/next-connection.png" width="50px" />      |
...
<picture>
  <source 
    ...
    srcset="/blockly/images/glossary/inputs-dark.png"
  /> 
  <img 
    alt="Block built from a value input, an end-of-row input, and a statement input." 
    src="/blockly/images/glossary/inputs.png" 
  />
</picture>
