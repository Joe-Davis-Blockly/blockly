...
<Image alt="A workspace with a category toolbox, scroll bars, trashcan, and zoom controls." src="/blockly/images/glossary/workspace.png" className="blockly" style="{{border: 1px solid #000; max-width: 70%;}}" />
...
| Connection       | Image                                                |
|------------------|------------------------------------------------------|
| Output           | <Image alt="an output connection" src="/blockly/images/connections/output-connection.png" className="connectionImg" />   |
| Input            | <Image alt="an input connection" src="/blockly/images/connections/input-connection.png" className="connectionImg" />    |
| Previous         | <Image alt="a previous connection" src="/blockly/images/connections/previous-connection.png" className="connectionImg" /> |
| Next             | <Image alt="a next connection" src="/blockly/images/connections/next-connection.png" className="connectionImg" />      |
