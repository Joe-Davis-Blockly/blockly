...
<Image alt="The UI of a maze application with an editor, an output panel, and a Run button." src="/blockly/images/application-overview/games-maze.png" className="blockly" />
