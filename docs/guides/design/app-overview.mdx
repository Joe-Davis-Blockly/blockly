...
<Image alt="The UI of a maze application with an editor, an output panel, and a Run button." src="/blockly/images/application-overview/games-maze.png" className="blockly" width="75%" />
...
<Image alt="The UI of a graph application with an editor, an output panel for an equation constructed by the user, and an output panel for a graph of that equation." src="/blockly/images/application-overview/graph-sample.png" width="75%" />
...
*   [Scratch](https://scratch.mit.edu/), an application for creating animations
    ...
    <Image alt="The Scratch user interface." src="/blockly/images/application-overview/mit-scratch.png" width="85%" />
...
*   [MakeCode Arcade](https://www.microsoft.com/en-us/makecode), an application
    ...
    <Image alt="The MakeCode Arcade user interface." src="/blockly/images/application-overview/makecode-arcade.png" width="85%" />
...
*   [MIT App Inventor](https://appinventor.mit.edu/), an application for
    ...
    <Image alt="The GUI designer in the App Inventor user interface" src="/blockly/images/application-overview/mit-app-inventor-gui.png" width="85%" />
    <Image alt="The Blockly editor in the App Inventor user interface" src="/blockly/images/application-overview/mit-app-inventor-blockly.png" width="85%" />
...
codelab](/blockly/codelabs/getting-started/codelab-overview/).
