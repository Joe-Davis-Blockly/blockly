...
![The UI of a graph application with an editor, an output panel for an equation
constructed by the user, and an output panel for a graph of that
equation.](/blockly/images/application-overview/graph-sample.png){: width="75%"}
...
*   [Scratch](https://scratch.mit.edu/), an application for creating animations
    ...
    ![The Scratch user
    interface.](/blockly/images/application-overview/mit-scratch.png){: width="85%"}
...
*   [MakeCode Arcade](https://www.microsoft.com/en-us/makecode), an application
    ...
    ![The MakeCode Arcade user
    interface.](/blockly/images/application-overview/makecode-arcade.png){: width="85%"}
...
*   [MIT App Inventor](https://appinventor.mit.edu/), an application for
    ...
    ![The GUI designer in the App Inventor user
    interface](/blockly/images/application-overview/mit-app-inventor-gui.png){: width="85%"}
    ![The Blockly editor in the App Inventor user
    interface](/blockly/images/application-overview/mit-app-inventor-blockly.png){: width="85%"}
