...
CSS](/blockly/guides/configure/web/toolboxes/appearance#category_css).
...
*   If your component is a subclass of `Field` or `Icon`, override the
    ...
    CSS](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#css)
    or [Create the icon's
    view](/blockly/guides/create-custom-blocks/icons/creating-custom-icons/basic-implementation#create_the_icons_view).
...
*   Your rule has a lower priority than another rule. This is usually due to a
    ...
    *   If possible, [add a custom class](#custom_css_classes) to your target
