...
![An if block with a
comment](/blockly/images/workspace-comments/block-comment.png)
...
[editable]: /blockly/guides/create-custom-blocks/define/block-state#editable_state
[config-option]: /blockly/guides/configure/web/configuration_struct#the_options_dictionary