...
*   The `FocusManager` is a singleton that coordinates focus across all of
    ...
    custom code to [interact with the focus system](#use_the_focus_manager).
...
*   An `IFocusableTree` is an independent area of a Blockly editor, such as a
    ...
    custom toolbox, you probably won't need to [implement it](#custom_classes).
...
*   Classes that create a visible component that manages its own focus, such as
    ...
    ephemeral focus](#ephemeral_focus) when they start and return it when they
...
If you use
[`WidgetDiv`](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#widgetdiv_sample_code)
or
[`DropDownDiv`](/guides/create-custom-blocks/fields/customizing-fields/creating#dropdowndiv_sample_code),
