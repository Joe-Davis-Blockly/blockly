...
![lists_repeat block in English](/blockly/images/createlist-en.png) \
![lists_repeat block in Spanish](/blockly/images/createlist-es.png) \
![lists_repeat block in Korean](/blockly/images/createlist-ko.png) \
![lists_repeat block in right-to-left Arabic](/blockly/images/createlist-ar.png)
...
registration](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#json_and_registration).
...
You can use [token references](#use_localization_tokens_in_json) in the
following JSON keys:
