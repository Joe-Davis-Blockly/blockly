...
variable.](/blockly/images/variable-dropdown.png)
...
*   [Specify a variable type and its blocks](#typed_variable_blocks), including
    getters and setters.
*   [Configure the toolbox](#add_variables_to_toolbox) to use your variable type
    and blocks.
...
`foo`.](/blockly/images/getter-and-setter.png)
...
button.](/blockly/images/variables-category.png)
...
blocks, and getter blocks.](/blockly/images/variables-category-filled.png)
