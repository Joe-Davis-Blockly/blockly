...
and may optionally be part of the [on-block display](#on-block_display).
...
![Turtle field block collapsing](/blockly/images/fields/yertle_collapsing.gif)
...
[field-generator]: /blockly/guides/create-custom-blocks/code-generation/block-code#get_field_values