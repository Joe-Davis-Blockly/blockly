...
1.  [Implement a constructor](#implementing_a_constructor).
1.  [Register a JSON key and implement `fromJson`](#json_and_registration).
...
1.  [Handle disposal of event listeners](#disposing) (UI disposal is handled for
    you).
1.  [Implement value handling](#value_handling).
...
1.  Add additional functionality such as:
    ...
    *   [On-block display updates](#updating_the_on-block_display).
    *   [Serialization](#serialization).
1.  Configure additional aspects of your field, such as:
    *   [Editable and serializable
        properties](#editable_and_serializable_properties)
    *   [CSS](#css)
...
tokens](/blockly/guides/configure/web/translations#use_localization_tokens_in_json)
using
...
[Angle](/blockly/guides/create-custom-blocks/fields/built-in-fields/angle)
...
showing
[editors](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#creating_an_editor)).
...
[`Blockly.utils.browserEvents.conditionalBind`](/blockly/reference/js/blockly.utils_namespace.browserevents_namespace.conditionalbind_1_function.md)
...
you can use the
[`Blockly.browserEvents.bind`](/blockly/reference/js/blockly.utils_namespace.browserevents_namespace.bind_1_function.md)
function.
...
![Flowchart describing the order in which validators are run](/blockly/images/validation-order.svg)
...
in the
[constructor](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#implementing_a_constructor)
...
render_](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#updating_the_on-block_display)
...
[`doValueInvalid_`](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#handling_invalid_values)
...
[`setValue`](/blockly/reference/js/blockly.field_class.setvalue_1_method.md)
...
override the
[`getText`](/blockly/reference/js/blockly.field_class.gettext_1_method.md)function
...
![Image of angle picker](/blockly/images/angle-picker.png)
...
![Image of text input editor](/blockly/images/text-input-editor.png)
...
[`getDisplayText_`](/blockly/reference/js/blockly.field_class.getdisplaytext__1_method.md)
...
size](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#updating_size).
...
the `render_`
function](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#customizing_rendering).

![Flowchart describing how to make decision of whether to override render_](/blockly/images/override-render-decision.svg)
...
1.  You should always [update the `size_`](/blockly/guides/create-custom-blocks/fields/customizing-fields/creating#updating_size)
...
method](#on-block_display), add a custom class to your field's `fieldGroup_`,
...
[field-generator]: /blockly/guides/create-custom-blocks/generating-code#getfieldvalue
