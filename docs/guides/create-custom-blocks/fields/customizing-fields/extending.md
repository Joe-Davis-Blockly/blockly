...
+   Its
    [editor](/blockly/guides/create-custom-blocks/fields/anatomy-of-a-field#editor_display).
+   Its
    [on-block display](/blockly/guides/create-custom-blocks/fields/anatomy-of-a-field#on-block_display).
+   The
