...
![a value block that accepts a single type][values-single-image]{: width="300"}
...
![a value block that accepts multiple types][values-multiple-image]{: width="300"}
...
![a value block that accepts any type][values-any-type-image]{: width="200"}
...
![a value block that returns its type and its supertype][values-subtype-image]{: width="350"}
...
type][values-parameterized-type-image]{: width="300"}
...
![statement blocks that have a forced order][statements-ordered-image]{: width="350"}
...
![statement blocks that allow lots of middle blocks][statements-multiple-middle-blocks-image]{: width="350"}
...
![statement blocks that allow no middle blocks][statements-no-middle-blocks-image]{: width="350"}
...
multiple of another, but not both][statements-either-or-image]{: width="550"}
