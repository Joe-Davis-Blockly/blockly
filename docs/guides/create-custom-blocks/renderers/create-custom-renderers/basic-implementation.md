...
![base renderer][base-renderer-image]{: width="300" }
...
[built-in-renderers]: /blockly/guides/create-custom-blocks/renderers/overview#built-in_renderers
...
[custom-renderer-codelab]: https://blocklycodelabs.dev/codelabs/custom-renderer/index.html
