...
<Image alt="connections with different dimensions" src="/blockly/images/rendering/connection-shapes/overridden-connection-constants.png" width={300} />
...
<Image alt="connections with different shapes" src="/blockly/images/rendering/connection-shapes/overridden-connection-shapes.png" width={100} />
...
<Image alt="the direction a block gets drawn in" src="/blockly/images/rendering/connection-shapes/drawing-direction.png" width={200} />
...
<Image alt="different connections with different shapes" src="/blockly/images/rendering/connection-shapes/connection-check-specific-shapes.png" width={300} />
...
Custom inputs can either:
  ...
  * Affect the outline of your block, like statement inputs
    ...
    <Image alt="image of outline inputs" src="/blockly/images/rendering/connection-shapes/outline-inputs.png" width={150} />

  * Or affect the internals of your block, like inline value inputs

    <Image alt="image of internal inputs" src="/blockly/images/rendering/connection-shapes/internal-inputs.png" width={200} />
