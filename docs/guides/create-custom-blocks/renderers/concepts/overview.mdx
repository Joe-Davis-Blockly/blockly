...
<Image alt="A repeat-for block with the rows outlined." src="/blockly/images/rendering/debug-renderer/row.png" width={200} />
...
<Image alt="A repeat-for block with the row spacers highlighted in blue" src="/blockly/images/rendering/debug-renderer/row-spacer.png" width={200} />
...
<Image alt="A repeat-for block with the elements outlined" src="/blockly/images/rendering/debug-renderer/element.png" width={200} />
...
<Image alt="A repeat-for block with the element spacers highlighted in pink" src="/blockly/images/rendering/debug-renderer/element-spacer.png" width={200} />
