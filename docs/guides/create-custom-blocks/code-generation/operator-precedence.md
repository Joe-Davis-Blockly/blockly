...
![blocks representing -(5 + 2)][negate-and-addition]{: width="200"}
...
![negate-and-addition][negate-and-addition]{: width="200"}
...
block.][negate-plus-two-with-child]{: width="150"}
...
block][negate-plus-two]{: width="150"}
...
*   You want to [ensure code is always parenthesized](#generate_correct_output),
