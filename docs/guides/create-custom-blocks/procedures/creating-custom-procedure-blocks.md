...
1.  When loading from JSON your blocks will need to grab a *reference* to their
...
[methods](/blockly/reference/js/blockly.procedures_namespace.iproceduremodel_interface.md)
...
[mutators](/blockly/guides/create-custom-blocks/mutators#ui_hooks) (which the
...
to your toolbox](/blockly/guides/configure/web/toolboxes/dynamic#json_1).
