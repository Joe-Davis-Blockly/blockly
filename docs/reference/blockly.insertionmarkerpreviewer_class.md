...
|  [serializeBlockToInsertionMarker(block)](./blockly.insertionmarkerpreviewer_class.serializeblocktoinsertionmarker_1_method.md) | <code>protected</code> | Transforms the given block into a JSON representation used to construct an insertion marker. |
