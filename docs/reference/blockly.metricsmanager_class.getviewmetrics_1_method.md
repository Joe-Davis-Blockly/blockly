...
[blockly](./blockly.md) &gt; [MetricsManager](./blockly.metricsmanager_class.md) &gt; [getViewMetrics](./blockly.metricsmanager_class.getviewmetrics_1_method.md)
...
|  --- | --- | --- |
|  opt\_getWorkspaceCoordinates | boolean | _(Optional)_ True to get the view metrics in workspace coordinates, false to get them in pixel coordinates. |
