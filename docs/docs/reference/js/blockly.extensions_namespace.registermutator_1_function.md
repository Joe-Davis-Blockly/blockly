...
|  opt\_helperFn | () =&gt; any | _(Optional)_ An optional function to apply after mixing in the object. |
|  opt\_blockList | string\[\] | _(Optional)_ A list of blocks to appear in the flyout of the mutator dialog. |
