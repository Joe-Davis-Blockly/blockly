...
The complete code used in this codelab can be viewed in the `blockly` repository under `docs/codelabs/custom-generator`.(https://github.com/RaspberryPiFoundation/blockly/docs/codelabs/custom-generator/complete-code).
