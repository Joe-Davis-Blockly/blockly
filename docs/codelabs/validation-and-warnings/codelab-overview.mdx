...
You can find the code for the [completed custom block](https://github.com/RaspberryPiFoundation/blockly/docs/codelabs/validation-and-warnings/complete-code/index.js) on GitHub.
