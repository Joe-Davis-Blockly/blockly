...
<ClassBlock className="codelabImages"> ![image](../../../static/images/codelabs/getting-started/play_sound_block.png) </ClassBlock>
...
<ClassBlock className="codelabImages"> ![image](../../../static/images/codelabs/getting-started/workspace_with_toolbox.png) </ClassBlock>
