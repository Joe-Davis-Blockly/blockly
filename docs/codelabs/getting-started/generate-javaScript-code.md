...
For more information on block generators, read the [generating code](/blockly/guides/create-custom-blocks/code-generation/overview#block-code_generators) page on the developer site.