...
Blocks can be defined in either JavaScript or JSON. The developer site has a full article on [how to define a block](/blockly/guides/create-custom-blocks/define/block-definitions#how_to_create_block_definitions).
