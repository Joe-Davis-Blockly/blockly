...
You can find the code for the [completed custom toolbox](https://github.com/RaspberryPiFoundation/blockly/docs/codelabs/custom-toolbox/complete-code) on GitHub.