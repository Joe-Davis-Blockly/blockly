...
The relevant files are in `docs/codelabs/custom-toolbox`. There are two versions of the app:
...
<ClassBlock className="codelabImages"> ![The default toolbox. A list of categories with a strip of colour to the left.](../../../static/images/codelabs/custom-toolbox/base_toolbox.png) </ClassBlock>
