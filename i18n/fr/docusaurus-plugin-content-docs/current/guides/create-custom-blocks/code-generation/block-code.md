...
*   `custom_compare` is a value block that has a value input named `LEFT`, a
    ...
    comparisons.](/blockly/images/code-generation/custom-compare.png)
...
*   `custom_if` is a statement block that has a checkbox field named `NOT`, a
    ...
    negate the if condition.](/blockly/images/code-generation/custom-if.png)

This document builds the generators step by step. You can find the completed
generators at the [end of this document](#complete_code_generators).
...
precedence](/blockly/guides/create-custom-blocks/code-generation/operator-precedence#valuetocode_precedence).
...
*   **Value blocks:** Return an array containing the code string and the
    ...
    precedence](/blockly/guides/create-custom-blocks/code-generation/operator-precedence#return_precedence).
